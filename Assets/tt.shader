//#EditorFriendly
//#node6:posx=-157:posy=62.5:title=Texture:title2=Normal:input0=(0,0):input0type=Vector2:
//#node5:posx=-166:posy=6.5:title=Texture:title2=Diffus:input0=(0,0):input0type=Vector2:
...
//#masterNode:posx=0:posy=0:title=Master Node:input0linkindexnode=5:input0linkindexoutput=0:input5linkindexnode=6:input5linkindexoutput=0:
//#sm=3.0
//#blending=Alpha
//#ShaderName
Shader "ShaderFusion/tt" {
	Properties {
...
//#DeferredVertexEnd
		...
		void surf (Input IN, inout SurfaceShaderFusion o) {
			...
			float alpha = 1.0;
//#PreFragBody
float4 node5 = tex2D(_Diffus,IN.sfuv1);
float4 node6 = tex2D(_Normal,IN.sfuv1);
//#FragBody
normal = (node6);
diffuse = (node5);
